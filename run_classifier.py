...
def main():
  ...
  # tbc=TensorBoardColab(graph_path='./all_scalars.json')


  # from tensorflow.python.summary.summary_iterator import summary_iterator

  # for summary in summary_iterator('/gdrive/My Drive/test_results/fast-bert/tensorboard/events.out.tfevents.1581594357.d7dd8a7cc663'):
